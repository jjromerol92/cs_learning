...
week: 15
phase: P3
title: "Java, classes, references and testing"
...
- **Prerequisite check:** Week 1 placement plus P1 programming abstractions.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** Java introduction; defining/using classes; arrays, maps and references; testing.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [HW 02: Java Introduction](https://sp26.datastructur.es/homeworks/hw02/) — Public specification/material.
- **OFFICIAL · Core · Homework/project:** [Official early testing exercise/project from the CS61B schedule](https://sp26.datastructur.es/) — Public specification/material.
...
- SYNTHESIZED TARGET: distinguish primitive values, object references, identity and equality.
- SYNTHESIZED TARGET: define a small class/API and test observable behavior.
- SYNTHESIZED TARGET: read compiler/test failures methodically.
...
```text
Let's do the groundwork for Week 15.
...
Start with the source map and prerequisite check for Week 15: Java, classes, references and testing.
```
