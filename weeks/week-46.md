...
week: 46
phase: P6
title: "Sorting, joins and query execution"
...
- **Prerequisite check:** Sorting, hashing, pages and C++.

## Exact official source map

- **CMU15445 — [Carnegie Mellon 15-445/645 — Intro to Database Systems](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) (Spring 2026):** Lectures #11–#14: sorting/aggregation, join algorithms and query execution I–II; Query Execution project; execution/planning homework.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Project:** [CMU Query Execution project](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Homework:** [CMU Execution & Planning homework](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Lecture notes:** [Official notes/slides #11–#14](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
...
- SYNTHESIZED TARGET: compare external sorting, hash aggregation and join algorithms.
- SYNTHESIZED TARGET: explain iterator/operator execution contracts.
- SYNTHESIZED TARGET: select a join strategy from cardinality, memory and ordering.
...
```text
Let's do the groundwork for Week 46.
...
Start with the source map and prerequisite check for Week 46: Sorting, joins and query execution.
```
