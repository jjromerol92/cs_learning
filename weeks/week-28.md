...
week: 28
phase: P4
title: "Instruction formats, CALL and calling conventions"
...
- **Phase:** P4 — Machine structures and architecture
- **Phase purpose:** Use Berkeley CS 61C's actual Summer 2026 sequence.
- **Prerequisite check:** RISC-V basics.

## Exact official source map

- **CS61C — [UC Berkeley CS 61C — Great Ideas in Computer Architecture](https://cs61c.org/su26/) (Summer 2026):** Instruction formats; CALL; calling convention; Lab 4.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Lab:** [CS61C Lab 4: Calling Convention](https://cs61c.org/su26/) — Public specification/material.
- **OFFICIAL · Core · Homework/discussion:** [CS61C homework/discussion on instruction formats and CALL](https://cs61c.org/su26/) — Public specification/material.
- **OFFICIAL · Official stretch · Project:** [CS61Classify project milestones aligned with calling convention](https://cs61c.org/su26/) — Public specification/material.
...
- SYNTHESIZED TARGET: encode/decode instruction fields conceptually.
- SYNTHESIZED TARGET: draw stack frames and identify caller/callee responsibilities.
- SYNTHESIZED TARGET: debug a convention violation from register/stack evidence.
...
```text
Let's do the groundwork for Week 28.
...
Start with the source map and prerequisite check for Week 28: Instruction formats, CALL and calling conventions.
```
