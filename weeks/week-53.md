...
week: 53
phase: P7
title: "Cryptographic building blocks and secure channels"
...
- **Prerequisite check:** Probability/number theory and security principles.

## Exact official source map

- **CS161 — [UC Berkeley CS 161 — Computer Security](https://sp26.cs161.org/) (Spring 2026 archived official site):** Symmetric crypto, hashes/MACs, authenticated encryption, key exchange, public-key encryption, signatures and implementation bugs.
- **CS161TEXT — [Berkeley CS 161 Computer Security Textbook](https://textbook.cs161.org/) (Open textbook):** Corresponding cryptography chapters.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS161 public cryptography discussion worksheets](https://sp26.cs161.org/) — Public specification/material.
- **OFFICIAL · Core · Reading work:** [CS161 textbook cryptography chapter questions/examples](https://textbook.cs161.org/) — Public specification/material.
- **OFFICIAL · Core · Exam-prep worksheet:** [Official CS161 exam-prep worksheet for cryptography](https://sp26.cs161.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: choose hash, MAC, signature, encryption or AE for the actual security property.
- SYNTHESIZED TARGET: explain freshness/replay and key-distribution assumptions.
- SYNTHESIZED TARGET: identify how correct primitives can still form an insecure protocol.
...
```text
Let's do the groundwork for Week 53.
...
Start with the source map and prerequisite check for Week 53: Cryptographic building blocks and secure channels.
```
