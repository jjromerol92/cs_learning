...
week: 23
phase: P3
title: "Hashing, tries and comparison-based sorting"
...
- **Phase:** P3 — Data structures and algorithms
- **Phase purpose:** Use Berkeley CS 61B and MIT 6.006 official sequence.
- **Prerequisite check:** Arrays, trees and asymptotics.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** Hashing, hash maps, tries and sorting.
- **MIT6006 — [MIT 6.006 — Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) (Spring 2020 OpenCourseWare):** Sorting and hashing lectures/assignments.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [Official CS61B HashMap homework](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Discussion/project:** [Official CS61B trie/sorting worksheet or project section](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Problem set:** [MIT 6.006 sorting/hashing problem-set sections](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) — Public specification/material.
...
- SYNTHESIZED TARGET: state assumptions behind expected O(1) hash-table operations.
- SYNTHESIZED TARGET: choose collision/resizing policy and test adversarial keys.
- SYNTHESIZED TARGET: compare stable/in-place sorting algorithms and their bounds.
...
```text
Let's do the groundwork for Week 23.
...
Start with the source map and prerequisite check for Week 23: Hashing, tries and comparison-based sorting.
```
