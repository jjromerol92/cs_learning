...
week: 33
phase: P5
title: "OS abstractions, protection and system calls"
...
- **Phase:** P5 — Operating systems
- **Phase purpose:** Use Berkeley CS 162's public schedule and OSTEP's official exercises.
- **Prerequisite check:** P4 machine structures and Week 2 CS162 placement.

## Exact official source map

- **CS162 — [UC Berkeley CS 162 — Operating Systems and System Programming](https://cs162.org/) (Spring 2026 public site):** Introduction; protection; systems programming/process and I/O opening lectures; Discussion 1.
- **OSTEP — [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (Open textbook and homework simulators):** Introduction and process abstraction chapters.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS162 Discussion 1 worksheet](https://cs162.org/static/dis/1.pdf) — Public specification/material.
- **OFFICIAL · Core · Homework/project:** [CS162 opening homework/project-0 material shown on the schedule](https://cs162.org/) — Public specification/material.
- **OFFICIAL · Core · Homework simulator:** [OSTEP process-introduction homework simulator(s)](https://pages.cs.wisc.edu/~remzi/OSTEP/Homework/homework.html) — Public specification/material.
...
- SYNTHESIZED TARGET: explain user/kernel mode, traps/system calls and isolation.
- SYNTHESIZED TARGET: distinguish process abstraction from program executable.
- SYNTHESIZED TARGET: trace a simple system-call path and its failure modes.
...
```text
Let's do the groundwork for Week 33.
...
Start with the source map and prerequisite check for Week 33: OS abstractions, protection and system calls.
```
