...
week: 44
phase: P6
title: "Storage managers and buffer pools"
...
- **Prerequisite check:** C++ primer, OS I/O/caches and data structures.

## Exact official source map

- **CMU15445 — [Carnegie Mellon 15-445/645 — Intro to Database Systems](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) (Spring 2026):** Lectures #04–#06: buffer pools, database storage II, storage models and compression; Storage homework; Buffer Pool Manager project.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [CMU Storage homework](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Project:** [CMU Buffer Pool Manager project](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Lecture notes:** [Official notes/slides #04–#06](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
...
- SYNTHESIZED TARGET: distinguish disk pages, in-memory frames, pinning, dirty state and eviction.
- SYNTHESIZED TARGET: state buffer-pool invariants and concurrency boundaries.
- SYNTHESIZED TARGET: relate row/column storage and compression to workload.
...
```text
Let's do the groundwork for Week 44.
...
Start with the source map and prerequisite check for Week 44: Storage managers and buffer pools.
```
