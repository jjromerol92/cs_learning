...
week: 34
phase: P5
title: "Processes, files, threads and I/O"
...
- **Prerequisite check:** OS abstraction and C systems programming.

## Exact official source map

- **CS162 — [UC Berkeley CS 162 — Operating Systems and System Programming](https://cs162.org/) (Spring 2026 public site):** Processes and I/O; files and threads; relevant discussion/homework.
- **OSTEP — [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (Open textbook and homework simulators):** Process API and file-I/O chapters.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS162 official process/files/thread discussion worksheet](https://cs162.org/) — Public specification/material.
- **OFFICIAL · Core · Homework simulator:** [OSTEP process API / file-I/O homework simulator(s)](https://pages.cs.wisc.edu/~remzi/OSTEP/Homework/homework.html) — Public specification/material.
- **OFFICIAL · Official stretch · Project:** [CS162 Project 1 or introductory project design document — opening milestone](https://cs162.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: explain fork/exec/wait and descriptor inheritance.
- SYNTHESIZED TARGET: distinguish process and thread resources.
- SYNTHESIZED TARGET: reason about partial/blocking I/O.
...
```text
Let's do the groundwork for Week 34.
...
Start with the source map and prerequisite check for Week 34: Processes, files, threads and I/O.
```
