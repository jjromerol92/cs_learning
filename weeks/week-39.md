...
week: 39
phase: P5
title: "Virtual memory: replacement, faults and memory homework"
...
- **Prerequisite check:** Week 38 translation/paging.

## Exact official source map

- **CS162 — [UC Berkeley CS 162 — Operating Systems and System Programming](https://cs162.org/) (Spring 2026 public site):** Virtual Memory 3; Homework 4: Memory; Project 2 design/implementation context.
- **OSTEP — [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (Open textbook and homework simulators):** Page replacement and complete VM chapters/homework.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [CS162 HW4: Memory](https://cs162.org/) — Public specification/material.
- **OFFICIAL · Core · Homework simulator:** [OSTEP page-replacement homework simulator(s)](https://pages.cs.wisc.edu/~remzi/OSTEP/Homework/homework.html) — Public specification/material.
- **OFFICIAL · Official stretch · Project:** [CS162 Project 2: Threads or VM-related project milestone shown on the schedule](https://cs162.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: distinguish minor/major faults and locality/working-set effects.
- SYNTHESIZED TARGET: compare replacement policies on explicit traces.
- SYNTHESIZED TARGET: explain why a policy can exhibit anomalous behavior.
...
```text
Let's do the groundwork for Week 39.
...
Start with the source map and prerequisite check for Week 39: Virtual memory: replacement, faults and memory homework.
```
