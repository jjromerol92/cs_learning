...
week: 32
phase: P4
title: "Parallelism and virtual memory"
...
- **Prerequisite check:** All P4 topics.

## Exact official source map

- **CS61C — [UC Berkeley CS 61C — Great Ideas in Computer Architecture](https://cs61c.org/su26/) (Summer 2026):** Parallelism; SIMD/OpenMP concepts; virtual memory; Labs/homework at the end of the schedule.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Lab:** [CS61C Lab 7: Parallelism](https://cs61c.org/su26/) — Public specification/material.
- **OFFICIAL · Core · Homework/discussion:** [CS61C virtual-memory homework/discussion sections](https://cs61c.org/su26/) — Public specification/material.
- **OFFICIAL · Core · Review/past exam:** [CS61C final review or past-exam machine-structures section](https://cs61c.org/su26/) — Public specification/material.
...
- SYNTHESIZED TARGET: explain page translation, TLBs and protection conceptually.
- SYNTHESIZED TARGET: identify data dependencies and false-sharing risks.
- SYNTHESIZED TARGET: integrate C, assembly, datapath, caches and VM in one execution trace.
...
```text
Let's do the groundwork for Week 32.
...
Start with the source map and prerequisite check for Week 32: Parallelism and virtual memory.
```
