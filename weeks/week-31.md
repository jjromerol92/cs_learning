...
- **Prerequisite check:** Binary representation and memory accesses.

## Exact official source map

- **CS61C — [UC Berkeley CS 61C — Great Ideas in Computer Architecture](https://cs61c.org/su26/) (Summer 2026):** Caches; cache addressing, associativity, replacement and locality.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS61C cache discussion worksheet](https://cs61c.org/su26/) — Public specification/material.
- **OFFICIAL · Core · Homework:** [CS61C cache homework sections](https://cs61c.org/su26/) — Public specification/material.
...
- SYNTHESIZED TARGET: compute tag/index/offset for a given cache.
- SYNTHESIZED TARGET: predict hits/misses from an access trace.
- SYNTHESIZED TARGET: connect source-level data layout with locality.
...
```text
Let's do the groundwork for Week 31.
...
Start with the source map and prerequisite check for Week 31: Caches and locality.
```
