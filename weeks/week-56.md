...
week: 56
phase: P8
title: "Reliable RPC and a linearizable key/value service"
...
- **Prerequisite check:** Week 55 RPC and synchronization.

## Exact official source map

- **MIT65840 — [MIT 6.5840 — Distributed Systems](https://pdos.csail.mit.edu/6.5840/) (Spring 2026):** Lab 2 Key/Value Server; course units on RPC semantics, consistency and linearizability.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Programming lab:** [MIT 6.5840 Lab 2: Key/Value Server](https://pdos.csail.mit.edu/6.5840/labs/lab-kvsrv1.html) — Public specification/material.
- **OFFICIAL · Core · Reading questions:** [Official reading questions on consistency/linearizability](https://pdos.csail.mit.edu/6.5840/) — Public specification/material.
...
- SYNTHESIZED TARGET: distinguish request loss, response loss, retry and duplicate execution.
- SYNTHESIZED TARGET: define operation semantics/idempotency explicitly.
- SYNTHESIZED TARGET: reason about linearizability from concurrent histories.
...
```text
Let's do the groundwork for Week 56.
...
Start with the source map and prerequisite check for Week 56: Reliable RPC and a linearizable key/value service.
```
