...
week: 19
phase: P3
title: "Binary search trees, B-trees and red-black trees"
...
- **Prerequisite check:** Recursion, invariants and asymptotics.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** BSTs; B-trees; red-black trees and balanced-search-tree invariants.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework/project:** [Official CS61B BST map homework/project](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Discussion:** [Official tree discussion worksheet(s)](https://sp26.datastructur.es/) — Public specification/material.
...
- SYNTHESIZED TARGET: prove search-tree ordering is preserved by operations.
- SYNTHESIZED TARGET: relate tree height to operation complexity.
- SYNTHESIZED TARGET: explain how red-black trees encode balanced multiway trees.
...
```text
Let's do the groundwork for Week 19.
...
Start with the source map and prerequisite check for Week 19: Binary search trees, B-trees and red-black trees.
```
