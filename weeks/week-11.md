...
week: 11
phase: P2
title: "Asymptotics, recurrences and algorithmic cost"
...
- **Prerequisite check:** Induction and algebra.

## Exact official source map

- **MITMCS — [MIT 6.1200J — Mathematics for Computer Science](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) (Spring 2024 OpenCourseWare):** Lectures 5–7: sums, asymptotics, recurrences and related analysis.
- **MIT6006 — [MIT 6.006 — Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) (Spring 2020 OpenCourseWare):** Introductory algorithm-analysis lecture/notes.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Problem set:** [MIT Mathematics for CS Problem Set 3](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) — Public specification/material.
- **OFFICIAL · Core · Official assignment material:** [MIT 6.006 introductory analysis exercises/assignment sections](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) — Public specification/material.
...
- SYNTHESIZED TARGET: derive rather than merely quote a growth bound.
- SYNTHESIZED TARGET: solve simple recurrences by expansion/substitution.
- SYNTHESIZED TARGET: state the workload and cost model behind complexity claims.
...
```text
Let's do the groundwork for Week 11.
...
Start with the source map and prerequisite check for Week 11: Asymptotics, recurrences and algorithmic cost.
```
