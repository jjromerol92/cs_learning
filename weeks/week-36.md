...
week: 36
phase: P5
title: "Condition variables, semaphores and monitors"
...
- **Prerequisite check:** Week 35 locks/races.

## Exact official source map

- **CS162 — [UC Berkeley CS 162 — Operating Systems and System Programming](https://cs162.org/) (Spring 2026 public site):** Semaphores, monitors, readers/writers and advanced synchronization.
- **OSTEP — [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) (Open textbook and homework simulators):** Condition variables and semaphores chapters/homework.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS162 official synchronization worksheet for condition variables/monitors](https://cs162.org/) — Public specification/material.
- **OFFICIAL · Core · Homework simulator:** [OSTEP condition-variable/semaphore homework simulator(s)](https://pages.cs.wisc.edu/~remzi/OSTEP/Homework/homework.html) — Public specification/material.
- **OFFICIAL · Official stretch · Project:** [CS162 Threads project design/implementation milestone](https://cs162.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: write the predicate associated with every wait.
- SYNTHESIZED TARGET: explain Mesa-style wait loops and wakeups.
- SYNTHESIZED TARGET: distinguish safety, liveness and fairness.
...
```text
Let's do the groundwork for Week 36.
...
Start with the source map and prerequisite check for Week 36: Condition variables, semaphores and monitors.
```
