...
week: 47
phase: P6
title: "Query planning, transactions and concurrency control"
...
- **Phase:** P6 — Database systems
- **Phase purpose:** Use CMU 15-445/645's Spring 2026 schedule and BusTub projects.
- **Prerequisite check:** Synchronization, probability/cardinality and query execution.

## Exact official source map

- **CMU15445 — [Carnegie Mellon 15-445/645 — Intro to Database Systems](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) (Spring 2026):** Lectures #15–#21: optimization I–II, concurrency-control theory, 2PL, timestamp ordering and MVCC I–II; Transactions homework; Concurrency Control project.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [CMU Transactions homework](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Project:** [CMU Concurrency Control project](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Lecture notes:** [Official notes/slides #15–#21](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
...
- SYNTHESIZED TARGET: identify anomalies from an explicit schedule.
- SYNTHESIZED TARGET: distinguish serializability, isolation levels, 2PL, timestamp ordering and MVCC.
- SYNTHESIZED TARGET: explain planner estimates and where they can fail.
...
```text
Let's do the groundwork for Week 47.
...
Start with the source map and prerequisite check for Week 47: Query planning, transactions and concurrency control.
```
