...
week: 22
phase: P3
title: "Shortest paths, minimum spanning trees and DAGs"
...
- **Prerequisite check:** Graph traversal and priority queues.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** Shortest paths, MSTs, DAGs/topological ordering.
- **MIT6006 — [MIT 6.006 — Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) (Spring 2020 OpenCourseWare):** Weighted shortest paths, Bellman–Ford, Dijkstra and Johnson.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Project:** [Official CS61B shortest-path/MST project sections](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Problem set:** [MIT 6.006 weighted-shortest-path problem-set sections](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) — Public specification/material.
...
- SYNTHESIZED TARGET: explain relaxation and algorithm preconditions.
- SYNTHESIZED TARGET: construct a counterexample when an algorithm's assumptions fail.
- SYNTHESIZED TARGET: distinguish shortest-path tree, MST and topological order.
...
```text
Let's do the groundwork for Week 22.
...
Start with the source map and prerequisite check for Week 22: Shortest paths, minimum spanning trees and DAGs.
```
