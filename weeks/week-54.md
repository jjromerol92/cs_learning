...
week: 54
phase: P7
title: "Web, authentication and network security"
...
- **Phase:** P7 — Networking and security
- **Phase purpose:** Use Stanford CS 144 checkpoints and Berkeley CS 161 topic blocks.
- **Prerequisite check:** Networking, databases and cryptographic foundations.

## Exact official source map

- **CS161 — [UC Berkeley CS 161 — Computer Security](https://sp26.cs161.org/) (Spring 2026 archived official site):** Introduction to web; cookies/CSRF; certificates/passwords; XSS; UI attacks; SQL injection; later network-security topic block.
- **CS161TEXT — [Berkeley CS 161 Computer Security Textbook](https://textbook.cs161.org/) (Open textbook):** Corresponding web and network chapters.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion:** [CS161 public web-security discussion worksheets (cookies/CSRF, XSS, SQL injection)](https://sp26.cs161.org/) — Public specification/material.
- **OFFICIAL · Core · Reading work:** [CS161 textbook web/network chapter questions/examples](https://textbook.cs161.org/) — Public specification/material.
- **OFFICIAL · Core · Exam-prep worksheet:** [One official CS161 exam-prep worksheet for web/network security](https://sp26.cs161.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: distinguish authentication, session integrity and authorization.
- SYNTHESIZED TARGET: explain browser-origin/cookie rules behind CSRF/XSS defenses.
- SYNTHESIZED TARGET: trace trust and attack surfaces across DNS, TLS, HTTP and application logic.
...
```text
Let's do the groundwork for Week 54.
...
Start with the source map and prerequisite check for Week 54: Web, authentication and network security.
```
