...
- **Prerequisite check:** Week 49 byte stream, state machines and timers.

## Exact official source map

- **CS144 — [Stanford CS 144 — Introduction to Computer Networking](https://cs144.github.io/) (Public course site):** Checkpoint 2 TCP receiver; Checkpoint 3 TCP sender; lectures on reliability and TCP.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Checkpoint:** [Checkpoint 2: the TCP receiver](https://cs144.github.io/) — Public specification/material.
- **OFFICIAL · Core · Checkpoint:** [Checkpoint 3: the TCP sender](https://cs144.github.io/) — Public specification/material.
- **OFFICIAL · Core · Starter tests:** [Official checkpoint tests](https://cs144.github.io/) — Public specification/material.
...
- SYNTHESIZED TARGET: reason about sequence-space wrapping, reassembly and acknowledgments.
- SYNTHESIZED TARGET: explain retransmission timers and sender window behavior.
- SYNTHESIZED TARGET: preserve transport state-machine invariants under loss/reordering.
...
```text
Let's do the groundwork for Week 50.
...
Start with the source map and prerequisite check for Week 50: TCP receiver and sender.
```
