...
week: 9
phase: P2
title: "Logic, sets, quantifiers and proof methods"
...
- **Prerequisite check:** Comfort with algebraic manipulation and basic programming.

## Exact official source map

- **MITMCS — [MIT 6.1200J — Mathematics for Computer Science](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) (Spring 2024 OpenCourseWare):** Lectures 1–3: propositions, predicates, sets, functions, proof methods.
- **CS70 — [UC Berkeley CS 70 — Discrete Mathematics and Probability Theory](https://www.eecs70.org/) (Summer 2026):** Opening notes/discussions on logic and proofs.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Problem set:** [MIT Mathematics for CS Problem Set 1](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) — Public specification/material.
- **OFFICIAL · Core · Homework/discussion:** [CS 70 Homework 0 and opening discussion worksheet](https://www.eecs70.org/assets/pdf/hw00.pdf) — Public specification/material.
...
- SYNTHESIZED TARGET: translate informal claims into quantified statements.
- SYNTHESIZED TARGET: select direct proof, contradiction, contrapositive or counterexample appropriately.
- SYNTHESIZED TARGET: distinguish empirical evidence from proof.
...
```text
Let's do the groundwork for Week 09.
...
Start with the source map and prerequisite check for Week 09: Logic, sets, quantifiers and proof methods.
```
