...
week: 45
phase: P6
title: "Hash tables, indexes, filters and index concurrency"
...
- **Prerequisite check:** Trees, hashing, concurrency and buffer pools.

## Exact official source map

- **CMU15445 — [Carnegie Mellon 15-445/645 — Intro to Database Systems](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) (Spring 2026):** Lectures #07–#10: hash tables, indexes/filters I–II and index concurrency; Indexes & Filters homework; Database Index project.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Homework:** [CMU Indexes & Filters homework](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Project:** [CMU Database Index project](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
- **OFFICIAL · Core · Lecture notes:** [Official notes/slides #07–#10](https://15445.courses.cs.cmu.edu/spring2026/schedule.html) — Public specification/material.
...
- SYNTHESIZED TARGET: choose an index from predicate/workload requirements.
- SYNTHESIZED TARGET: explain B+ tree page splits and search invariants.
...
```text
Let's do the groundwork for Week 45.
...
Start with the source map and prerequisite check for Week 45: Hash tables, indexes, filters and index concurrency.
```
