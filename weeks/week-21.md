...
- **Prerequisite check:** Queues/stacks, recursion and graph definitions.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** Graph representations, traversals and connectivity.
- **MIT6006 — [MIT 6.006 — Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) (Spring 2020 OpenCourseWare):** BFS and DFS lectures/assignments.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion/project:** [Official CS61B graph-traversal discussion/project section](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Problem set:** [MIT 6.006 BFS/DFS problem-set sections](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) — Public specification/material.
...
- SYNTHESIZED TARGET: choose adjacency-list/matrix representation from density and operations.
- SYNTHESIZED TARGET: state BFS/DFS frontier and visited invariants.
- SYNTHESIZED TARGET: derive O(V+E) with representation assumptions.
...
```text
Let's do the groundwork for Week 21.
...
Start with the source map and prerequisite check for Week 21: Graph representations, BFS and DFS.
```
