...
- **Prerequisite check:** Trees, arrays and asymptotics.

## Exact official source map

- **CS61B — [UC Berkeley CS 61B — Data Structures](https://sp26.datastructur.es/) (Spring 2026):** Heaps and priority queues.
- **MIT6006 — [MIT 6.006 — Introduction to Algorithms](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) (Spring 2020 OpenCourseWare):** Heaps and priority-queue lecture/assignment material.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Discussion/homework:** [Official CS61B heap/priority-queue worksheet or homework](https://sp26.datastructur.es/) — Public specification/material.
- **OFFICIAL · Core · Problem set:** [MIT 6.006 heap exercise/problem-set sections](https://ocw.mit.edu/courses/6-006-introduction-to-algorithms-spring-2020/) — Public specification/material.
...
- SYNTHESIZED TARGET: state heap shape/order invariants.
- SYNTHESIZED TARGET: trace swim/sink and derive their complexity.
- SYNTHESIZED TARGET: recognize when a priority queue matches the operation mix.
...
```text
Let's do the groundwork for Week 20.
...
Start with the source map and prerequisite check for Week 20: Heaps and priority queues.
```
