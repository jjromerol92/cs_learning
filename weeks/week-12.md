...
week: 12
phase: P2
title: "Number theory, modular arithmetic and RSA foundations"
...
- **Prerequisite check:** Proof and induction.

## Exact official source map

- **MITMCS — [MIT 6.1200J — Mathematics for Computer Science](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) (Spring 2024 OpenCourseWare):** Lectures 8–10: number theory and modular arithmetic.
- **CS70 — [UC Berkeley CS 70 — Discrete Mathematics and Probability Theory](https://www.eecs70.org/) (Summer 2026):** Modular arithmetic, RSA, polynomials/error-correction topic block.

## Official source work

These are the only required exercises for this week.

- **OFFICIAL · Core · Problem set:** [MIT Mathematics for CS Problem Set 4](https://ocw.mit.edu/courses/6-1200j-mathematics-for-computer-science-spring-2024/) — Public specification/material.
- **OFFICIAL · Core · Discussion/homework:** [CS 70 official modular-arithmetic/RSA discussion and homework sections](https://www.eecs70.org/) — Public specification/material.
...
- SYNTHESIZED TARGET: use gcd, modular inverses and fast exponentiation correctly.
- SYNTHESIZED TARGET: explain the mathematical structure of RSA without confusing it with a complete secure protocol.
- SYNTHESIZED TARGET: prove small modular identities.
...
```text
Let's do the groundwork for Week 12.
...
Start with the source map and prerequisite check for Week 12: Number theory, modular arithmetic and RSA foundations.
```
